...
public class YouTubeAPIv3 {
    ...
    private JSONObject GetData(String urlAddress) throws JSONException {
        ...
        try {
            ...
            generateJSONObject(jsonResult, success, "GET", "", urlAddress, resp.responseCode().code(), null, null);
        } catch (Exception ex) {
            generateJSONObject(jsonResult, false, "GET", "", urlAddress, 0, ex.getClass().getName(), ex.getMessage());
            com.gmt2001.Console.err.printStackTrace(ex);
        }
