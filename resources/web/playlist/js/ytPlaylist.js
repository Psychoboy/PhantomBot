...
function handleNewSong(title, duration, requester, id) {
    ...
    $('#currentSongTable').html('<tr><th>Song Title</th><th>Requester</th><th>Duration</th><th>YouTube ID</th></tr>' +
            '<tr><td>' + title + '</td><td>' + requester + '</td><td>' + duration + '</td><td><a href=https://youtu.be/' + id + ' target="_blank">' + id + '</a></td></tr>');
}
...
function handlePlayList(d) {
    ...
    for (var i in d['playlist']) {
        ...
        tableData += '<tr><td>' + title + '</td><td>' + duration + '</td><td><a href=https://youtu.be/' + id + ' target="_blank">' + id + '</a></td></tr>';
    }
...
function handleSongList(d) {
    ...
    for (var i in d['songlist']) {
        ...
        tableData += '<tr><td>' + title + '</td><td>' + requester + '</td><td>' + duration + '</td><td><a href=https://youtu.be/' + id + ' target="_blank">' + id + '</a></td></tr>';
    }
